...
<!-- 
     ...
     request영역 : 하나의 요청에 의해 호출된 페이지 및 포워드페이지
 ...
 <%
    ...
    // getAttribute 메서드의 반환타입은 Object이므로 형변환이 필요하다.
 ...
 <!-- 링크 또는 form을 이용해서 페이지를 다시 요청하게되면 페이지 영역이 초기화됩니다. -->
 ...
 <!--removeAttribute메소드는 값이 없는 경우 오류를 발생하지 않는다.
